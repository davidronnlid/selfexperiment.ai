...
// Oura variable mappings - following same pattern as Withings
const OURA_VARIABLE_MAP = {
  ...
  total_sleep_duration: {
    slug: "oura_total_sleep_duration", 
    label: "Oura Total Sleep Duration",
    unit: "seconds",
    category: "Sleep"
  },
  rem_sleep_duration: {
    slug: "oura_rem_sleep_duration",
    label: "Oura REM Sleep Duration", 
    unit: "seconds",
    category: "Sleep"
  },
  deep_sleep_duration: {
    slug: "oura_deep_sleep_duration",
    label: "Oura Deep Sleep Duration",
    unit: "seconds", 
    category: "Sleep"
  },
  light_sleep_duration: {
    slug: "oura_light_sleep_duration",
    label: "Oura Light Sleep Duration",
    unit: "seconds",
    category: "Sleep"
  },
  efficiency: {
    slug: "oura_efficiency",
    label: "Oura Sleep Efficiency",
    unit: "%",
    category: "Sleep"
  },
  sleep_latency: {
    slug: "oura_sleep_latency", 
    label: "Oura Sleep Latency",
    unit: "seconds",
    category: "Sleep"
  },
  ...
  // Readiness variables
  readiness_score: {
    slug: "oura_readiness_score",
    label: "Oura Readiness Score", 
    unit: "score",
    category: "Recovery"
  },
  temperature_deviation: {
    slug: "oura_temperature_deviation",
    label: "Oura Temperature Deviation",
    unit: "°C", 
    category: "Recovery"
  },
  temperature_trend_deviation: {
    slug: "oura_temperature_trend_deviation",
    label: "Oura Temperature Trend Deviation",
    unit: "°C",
    category: "Recovery"
  },
  ...
  hr_lowest: {
    slug: "oura_hr_lowest",
    label: "Oura Lowest Heart Rate",
    unit: "bpm",
    category: "Heart Rate"
  },
  hr_average: {
    slug: "oura_hr_average", 
    label: "Oura Average Heart Rate",
    unit: "bpm",
    category: "Heart Rate"
  },
  ...
  calories_active: {
    slug: "oura_calories_active",
    label: "Oura Active Calories",
    unit: "kcal",
    category: "Activity"
  },
  calories_total: {
    slug: "oura_calories_total",
    label: "Oura Total Calories", 
    unit: "kcal",
    category: "Activity"
  }
};
    ...
    async function ensureVariablesExist(supabase, userId) {
      ...
      for (const [key, varInfo] of Object.entries(OURA_VARIABLE_MAP)) {
        ...
        if (existingVar && !selectError) {
          ...
          console.log(`[Oura Sync All] Variable ${varInfo.slug} already exists with id ${existingVar.id}`);
        } else {
          // Create new variable
          ...
          if (insertError) {
            console.error(`[Oura Sync All] Error creating variable ${varInfo.slug}:`, insertError);
            throw new Error(`Failed to create variable ${varInfo.slug}: ${insertError.message}`);
          }

          variableIds[varInfo.slug] = newVar.id;
          console.log(`[Oura Sync All] Created new variable ${varInfo.slug} with id ${newVar.id}`);
        }
      }
